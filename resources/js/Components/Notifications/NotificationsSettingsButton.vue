...
<template>
    <div v-if="canShow">
        <button
            type="button"
            class="btn btn-ghost btn-square h-auto min-h-0 px-2.5 py-1.5 rounded-xl border border-base-300/70 hover:border-primary/60 hover:bg-primary/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary/40"
