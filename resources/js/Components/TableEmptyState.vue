...
<template>
    <div
        class="hero min-h-[11rem] rounded-box bg-base-200/40 py-10 px-4 border border-base-content/5"
        role="status"
        aria-live="polite"
    >
        <div class="hero-content flex-col gap-4 text-center max-w-md">
            <div class="rounded-full bg-base-100/80 p-5 shadow-sm ring-1 ring-base-content/10">
                <svg
                    class="mx-auto h-16 w-16 sm:h-20 sm:w-20 text-base-content/30"
