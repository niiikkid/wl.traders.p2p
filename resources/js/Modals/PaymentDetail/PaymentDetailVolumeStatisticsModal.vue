...
const paymentDetailId = computed(() => (
...
const volumeStatisticsRoute = computed(() => {
    ...
    return viewStore.isAdminViewMode
        ? route('admin.payment-details.volume-statistics', paymentDetailId.value)
        : route('payment-details.volume-statistics', paymentDetailId.value);
});
                        ...
                        >
                            <div class="card-body gap-3 p-4">
                                <p class="text-xs text-base-content/60">
                                    Период, за который считаются объём и сделки по реквизиту
                                </p>
