...
<template>
    <ul class="menu menu-md w-full space-y-0.5">
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('agent.main.index') }]">
            <span
                @click="router.visit(route('agent.main.index'), { preserveScroll: true })"
                @keydown.enter.space="router.visit(route('agent.main.index'), { preserveScroll: true })"
                role="link"
                tabindex="0"
            >
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('agent.news.*') }]">
            <span
                @click="router.visit(route('agent.news.index'), { preserveScroll: true })"
                @keydown.enter.space="router.visit(route('agent.news.index'), { preserveScroll: true })"
                role="link"
                tabindex="0"
            >
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('agent.finances.*') }]">
            <span
                @click="router.visit(route('agent.finances.index'), { preserveScroll: true })"
                @keydown.enter.space="router.visit(route('agent.finances.index'), { preserveScroll: true })"
                role="link"
                tabindex="0"
            >
