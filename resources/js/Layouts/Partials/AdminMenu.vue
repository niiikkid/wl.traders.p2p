    ...
    <ul class="menu menu-md w-full space-y-0.5">
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.main.index') }]">
            <span
                ...
                tabindex="0"
            >
                <svg class="size-5 opacity-30" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 25 25" aria-hidden="true">
...
<!--        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.profit-calculator.*') }]">
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.feedback.*') }]">
            <span
                @click="router.visit(route('admin.feedback.index'), { preserveScroll: true })"
                @keydown.enter.space="router.visit(route('admin.feedback.index'), { preserveScroll: true })"
                role="link"
                tabindex="0"
            >
                <svg class="size-5 opacity-30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
