                ...
                <div class="card-body">
                    <div class="flex justify-between">
                        ...
                        <template v-if="viewStore.isAdminViewMode">
                            <div class="join">
                                <button
                                    @click.prevent="modalStore.openWithdrawalModal({ user }); setBalanceType('provider')"
                                    type="button"
                                ...
                                <button
                                    @click.prevent="modalStore.openDepositModal({ user }); setBalanceType('provider')"
                                    type="button"
                        ...
                        <template v-else-if="viewStore.isProviderLiquidityViewMode">
                            <div>
                                <button
                                    @click.prevent="modalStore.openWithdrawalModal({ user }); setBalanceType('provider')"
                                    type="button"
