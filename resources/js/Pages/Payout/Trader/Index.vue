...
import TraderPayoutsNav from '@/Components/Trader/TraderPayoutsNav.vue';
...
<template>
    <div>
        ...
        >
            <template #button>
                <PageToolbar v-if="viewStore.isTraderViewMode">
                    <PageToolbarAction
                        icon="export"
                        title="Выгрузить выплаты в Excel"
            ...
            <template #header>
                <div class="space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <TraderPayoutsNav :current="listTab" @select="openListTab" />
