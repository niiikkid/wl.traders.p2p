...
| Article | Summary | Updated |
|---------|---------|---------|
| [Legacy Feature Removal Technical Specification](feature-removal/legacy-feature-removal-technical-spec.md) | [Archived] Steps **1–18 shipped**; new detailed removal backlog **19–27** covers bank settings, NSPK, callback resend/log UI, support link, order eye reveal, and Cascade removal. | 2026-06-15 |
