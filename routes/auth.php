...
Route::middleware('auth')->group(function () {
    ...
    Route::get('auth/2fa', [Check2FACodeController::class, 'check'])->name('auth.2fa');
    Route::post('auth/2fa/validate', [Check2FACodeController::class, 'validate'])->name('auth.2fa.validate');
